...
# # Problem to Solve
# 
# Ever taken a BuzzFeed quiz to determine whether you’re more like a brownie or 
# a chocolate chip cookie? Turns out personality can be characterized in many 
# ways and—within the present-day psychological community—some of the most 
# common traits to describe personality include:
#   
...
# 
# These 5 personality traits are together referred to as “The Big 5.” 
# Psychologists (or those who are just curious about their personality!) might 
# use various personality tests to assess the relative strength of these traits 
# in one’s personality.
# 
# In a program called big5.R, in a folder called big5, write a program to analyze 
# the results of thousands of Big 5 personality tests.
#  
# ========================
